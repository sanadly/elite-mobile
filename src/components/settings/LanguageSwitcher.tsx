...
export function LanguageSwitcher() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>{t('account.menu.language')}</Text>
      ...
      <View style={styles.options}>
        ...
        >
          <View style={styles.optionContent}>
            ...
            <Text style={[styles.optionSubtext, language === 'en' && styles.optionSubtextActive]}>
              English
            </Text>
          </View>
          {language === 'en' && (
        ...
        >
          <View style={styles.optionContent}>
            ...
            <Text style={[styles.optionSubtext, language === 'ar' && styles.optionSubtextActive]}>
              Arabic
            </Text>
          </View>
          {language === 'ar' && (
